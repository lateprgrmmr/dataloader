...
sql = "INSERT INTO classes(name_of_class,hours_per_week_in_term,expected_number_of_participants,maximum_participants,assignment,lecture_id,credit_points,language,created_at) VALUES('test',5,22,30,'test',1,3,'english',NOW())"
